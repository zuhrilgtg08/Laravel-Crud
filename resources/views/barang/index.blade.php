...
<div class="wrapper">
    ...
    <!-- tombol -->
    <a href="barang/create" class="btn btn-warning m-3 float-right">Tambah Barang</a>
    ...
    <table class="table table-striped display" id="table_id">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="width: 100px; text-align:center;"><button class="btn btn-primary" style="width: 100px;"><a href="{{ route('barang.edit', $produk->id) }}" style="text-decoration: none; color:#fff;">Edit</a></button></td>
